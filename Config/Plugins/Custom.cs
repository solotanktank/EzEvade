...
{
    [ConfigPlugin(Name = "Custom", Author = "MeLoDag", Description = "Set your own config preset. Preset can be found in '%appdata%/ezEvade/Data.xml'.", RecomendedChampions = new[] { "All" }, Version = "1.0.1.0")]
